...
class DeterministicSamplingEnsemble(BaseEstimator):
    ...
    def __init__(self, base_classifier=KNeighborsClassifier(), number_of_classifiers=10, balance_ratio=0.50, oversampling=SVMSMOTE(k_neighbors=3), undersampling=NeighbourhoodCleaningRule()):
